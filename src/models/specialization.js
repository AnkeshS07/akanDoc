...
const sepcialization= new mongoose.Schema({
...
sepcialization.statics.paginate = async function (query, options) {
...
const specializationModel = mongoose.model("sepcialization", sepcialization);
