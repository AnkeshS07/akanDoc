...
//===========================================User verify Pass OTP Vaidation=================================================================//
...
//===========================================Provider forgot Pass OTP Vaidation=================================================================//
...
const profileUpdateProviderValidation = [
  body("qualification")
    .isIn(["mbbs", "phd", "pgi"])
    .withMessage(
      "Please select at least one qualification either mbbs or phd or pgi"
    ),
  body("specialization")
    .isIn(["Specialization1", "Specialization2", "Specialization3"])
    .withMessage(
      "Please select at least one specialization either Specialization1 or Specialization2 or Specialization3"
    ),
];
...
/**
 * The validate function checks if there are any validation errors in the request and sends a response
 * with the first error message if there are any.
 */

const validate = function (req, res, next) {
  const error = validationResult(req).array();
  if (!error.length) return next();
  res.status(400).send({ status: 400, message: error[0].msg });
};
